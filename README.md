...
*Used for sharing single Staler portal credentials between multiple STB boxes. This way it could also be used for centralized control of multiple STB boxes.*
